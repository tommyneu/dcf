    ...
    <div class="dcf-modal-wrapper">
      ...
      <div class="dcf-modal-content dcf-gallery-image-modal-content">
        ...
        <figure
          role="tabpanel"
          aria-live="polite"
          class="dcf-d-flex dcf-flex-nowrap dcf-flex-col dcf-ai-center dcf-jc-center dcf-m-auto dcf-1st"
        >
        </figure>
      </div>
    </div>
    ...
    allGalleryImages.forEach((singleImage, index) => {
      ...
      list.innerHTML = `
        ...
        <li
          ...
          class="dcf-ratio dcf-ratio-4x3 dcf-w-10 dcf-rounded dcf-overflow-hidden"
        >
